...
namespace Map
{
    public class Obstacle
    {
        ...
        {
            { ObstacleType.石頭堆, new List<string>() { "1001", "1002", "1003", "1004", "1011", "1012", "1013", "1031", "1032", "1041" } },
            ...
            { ObstacleType.迷幻院, new List<string>() { "1051" } },
        };
        ...
        {
            if (_unlockPotionId[Type].Contains(potion.code)) return true;
            return false;
        }
    }
}